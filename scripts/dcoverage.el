...
(defcustom dcoverage-run-clover-function
  (lambda ()
    (gradle-run "clean cloverGenerateReport cloverAggregateReport"))
  "The elisp function to execute in order to run clover to generate and aggregate test coverage results."
...
(message "Current directory: %s" (expand-file-name "."))
(princ "\n")
