...
public class StudentEnrollmentWindow {
    ...
    public static Stage editEnrollment(Section section, Dao<Section> sectionDao, Dao<Student> studentDao) throws Exception {
        ...
        Set<Student> students = StudentEnrollmentWindow.getStudentsInSection(section, studentDao);
        ...
        addButton.setOnAction(e -> {
            try {
                Student student = StudentEnrollmentWindow.getStudentFromInput(studentDao);
